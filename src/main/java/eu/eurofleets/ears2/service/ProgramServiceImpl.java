  ...
  implements ProgramService
{
  ...
  public List<Program> getProgramList() { return this.programRepository.findAll(); }
  ...
  public void setProgram(Program program) { this.programRepository.save(program); }



  
  public void setProgram(String programId, Program program) throws DuplicateIdException {
  ...
  public void removeProgram(String programId) { this.programRepository.deleteProgramByProgramId(programId); }
  ...
  public Project getProject(String projectId) { return this.projectRepository.findByProjectId(projectId); }
}
